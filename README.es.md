...
- **Estadística no paramétrica:** Mann-Kendall, pendiente de Theil-Sen,
  ...
  normalidad.
- **Detección de deriva del factor de corrección.** El factor contra la
  referencia se sigue por días, y solo se declara deriva cuando varios de los
  días recientes salen de la banda del historial anterior: un día raro no es
  deriva. Adaptado de Allka (UPC, 2025), cap. 4.
...
| `GET /drift[/<geo3>]` · `/ref-history[/<geo3>]` | deriva del factor · historial de cabina |
